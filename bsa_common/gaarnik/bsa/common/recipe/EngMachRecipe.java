...
public class EngMachRecipe {
	...
	public EngMachRecipe() {
		this.addSmelting(Item.ingotIron.itemID, new ItemStack(BSAItems.screwItem, 4), 0.7F);
		this.addSmelting(Item.ingotGold.itemID, new ItemStack(BSAItems.engCircuitItem, 4), 0.9F);
	}
