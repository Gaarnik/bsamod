...
public class EngElecMachBlock2 extends BlockContainer {
	// *******************************************************************
	private static final String GAME_NAME = "Eng. Electrical Machine 2";
	...
	// *******************************************************************
	public EngElecMachBlock2(int id, boolean isActive) {
	...
	public boolean onBlockActivated(World world, int x, int y, int z, EntityPlayer player, int side, float hitX, float hitY, float hitZ) {
		...
		((EngElecMachTileEntity2) tileEntity).energyStored += 100;
		
		player.openGui(BSAMod.instance, BSAGuiHandler.GUI_ELECTRICAL_ENG_MACH_2, world, x, y, z);
	...
	public static void registry() {
		...
		BSAMod.engElecMachBlock = new EngElecMachBlock2(id, false);
	...
	@Override
	public TileEntity createNewTileEntity(World world) { return new EngElecMachTileEntity2(); }
